        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Aluguel_DevolucaoCompleta", "([DataDevolucao] IS NULL AND [QuilometragemFinal] IS NULL AND [ValorTotal] IS NULL) OR ([DataDevolucao] IS NOT NULL AND [QuilometragemFinal] IS NOT NULL AND [ValorTotal] IS NOT NULL)");
                    table.CheckConstraint("CK_Aluguel_PeriodoPrevisto", "[DataPrevistaDevolucao] >= [DataRetirada]");
                    table.CheckConstraint("CK_Aluguel_QuilometragemFinal", "[QuilometragemFinal] IS NULL OR [QuilometragemFinal] >= [QuilometragemInicial]");
                    table.CheckConstraint("CK_Aluguel_QuilometragemInicial", "[QuilometragemInicial] >= 0");
                    table.CheckConstraint("CK_Aluguel_ValorDiaria", "[ValorDiaria] > 0");
                    table.CheckConstraint("CK_Aluguel_ValorTotal", "[ValorTotal] IS NULL OR [ValorTotal] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Aluguel_Veiculo_EmAberto",
                table: "Alugueis",
                column: "VeiculoId",
                unique: true,
                filter: "[DataDevolucao] IS NULL");
